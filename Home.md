...
Бекенд на postgres, nodejs и typescript(с включенным strict). ORM prisma. API framework Nest.
...
Фронтенд на react, typescript, react-router, vite. UI библиотека ReactMaterial и стейт менеджер Effector. 
